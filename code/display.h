...
#define DISPLAY_TIME_LONG		0
#define DISPLAY_TIME_SHORT		1
#define DISPLAY_LINE0			0
#define DISPLAY_LINE1			1
...
extern uint8_t fDisplayTemp(uint16_t iTemp, uint8_t ix, uint8_t iy);
